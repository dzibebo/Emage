...
public class MessageManager {
    ...
    private Component cannotRotateNonSquare;
    ...
    public void load() {
        ...
        this.cannotRotateNonSquare = prefix.append(miniMessage.deserialize(config.getString("messages.cannot-rotate-non-square", "<red>You can only rotate square images (e.g., 2x2, 3x3).")));
    ...
    public void sendCannotRotateNonSquare(@NotNull Audience audience) { audience.sendMessage(this.cannotRotateNonSquare); playSafely(audience, errorSound); }
